...
// lib.rs
//
// @author Cameron Kinsella <ckinsella@uwaterloo.ca>
// @date Feb 9 2023
//
#![no_std]
#![allow(unused)]
...
// // Allow converting from a tuple
// impl<I2C, E> From<(I2C, Error<E>)> for I2cError<I2C, E>
// where
//     I2C: Write<Error = E> + WriteRead<Error = E>,
// {
//     fn from((i2c, error): (I2C, Error<E>)) -> Self {
//         Self(i2c, error)
//     }
// }
